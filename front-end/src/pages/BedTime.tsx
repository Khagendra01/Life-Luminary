...
const BedTime = () => {
  ...
  const readStory = () => {
    ...
    utterance.rate = 1.0; // Adjust the rate. Lower values sound more like storytelling.
    ...
    <>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center">
          {" "}
          <img src={writingPeter} alt="404 Illustration" className="mb-8" />
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            Writing your story!!!
          </h1>
        </div>
      ) : (
        <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl m-4 mt-20">
          <div className="md:flex">
            <div className="md:flex-shrink-0">
              <img
                className="h-full md:h-48 w-full md:w-48 object-cover"
                src={bed}
                alt="Bedtime story"
              />
            </div>
            <div className="p-8">
              ...
              <button
                onClick={readStory}
                className="mt-3 px-2 py-1 bg-blue-500 text-white text-xs font-semibold rounded-lg"
              >
                <FontAwesomeIcon icon={faVolumeUp} /> Read Story
              </button>
              <button
                onClick={playMusic}
                className="mt-3 ml-2 px-2 py-1 bg-blue-500 text-white text-xs font-semibold rounded-lg"
              >
